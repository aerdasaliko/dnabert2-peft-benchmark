...
class ModelArguments:
    ...
    tinit: int = field(default=500, metadata={"help": "warmup steps before rank adaptation starts"})
    tfinal: int = field(default=1000, metadata={"help": "end step of adaptation"})
